...
## Canlı Demo
**Yayın Linki:** [https://reworld.onrender.com] 
**Demo Video:** [https://youtu.be/uaZCF-B8ITY]

## Kullanılan Teknolojiler
- **Frontend & Deployment:** Render, React, Tailwind CSS
...
## Nasıl Çalıştırılır?
Bu proje Render üzerinden geliştirilmiştir. Yerel ortamda çalıştırmak için:
